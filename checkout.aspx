                ...
                <div class="col">
                    ...
                    <div class="flex"> 
                        <div class="inputbox">
                            ...
                            <asp:RequiredFieldValidator ID="validation_exyear" runat="server" ErrorMessage="Please Enter Year" ControlToValidate="date" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>
                        <div class="inputbox">
